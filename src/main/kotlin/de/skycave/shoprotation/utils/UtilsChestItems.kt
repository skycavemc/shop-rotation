...
object UtilsChestItems {
    ...
    fun openGUIChestItems(player: Player, view: GUIView, args: Array<out String>) {
        ...
        setPresetChestItems(player, gui, Material.PINK_STAINED_GLASS_PANE)
    ...
    private fun setPresetChestItems(player: Player, gui: GUI, material: Material) {
        ...
        gui.formatPattern(pattern.startAtLine(1)).formatPattern(pattern.startAtLine(6))
            .setItem(6,1, ItemBuilder.of(Material.ARROW).name("&ccZurück").asItem()) {
